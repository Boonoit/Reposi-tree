...
like `https://your-username.github.io/my-park-trees/`. Open it. You should
see the welcome screen — the configuration isn't filled in yet, so it can't
load any data, but that's expected. We'll fix that in step 4.
